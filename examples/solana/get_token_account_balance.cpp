...
int main() {
  ...
  std::vector<TokenAccount> token_accounts = connection.get_token_accounts_by_owner(PublicKey("CFAkMBwYYpzVHkSzJ4bWYYV1GatZP1YjSkfvPfLq2ZzA"), NATIVE_MINT).unwrap();
