// clang++ spl-token-swap.cpp -o spl-token-swap -std=c++17 -I ../../src/ -lssl -lcrypto -lsodium
...
int main() {
  ...
  auto program = Program::load(provider, "spl-token-swap.json", PublicKey("SwapsVeCiPHMUAtzQWZw7RjsKjgCjhwU55QGu4U1Szw"));
