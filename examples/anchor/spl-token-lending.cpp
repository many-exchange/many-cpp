// clang++ spl-token-lending.cpp -o spl-token-lending -std=c++17 -I ../../src/ -lssl -lcrypto -lsodium
...
int main() {
  ...
  auto program = Program::load(provider, "spl-token-lending.json", PublicKey("6TvznH3B2e3p2mbhufNBpgSrLx6UkgvxtVQvopEZ2kuH"));
