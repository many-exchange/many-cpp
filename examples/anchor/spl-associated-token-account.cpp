// clang++ spl-associated-token-account.cpp -o spl-associated-token-account -std=c++17 -I ../../src/ -lssl -lcrypto -lsodium
...
int main() {
  ...
  auto program = Program::load(provider, "spl-associated-token-account.json", PublicKey("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL"));
