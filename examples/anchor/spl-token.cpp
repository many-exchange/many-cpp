// clang++ spl-token.cpp -o spl-token -std=c++17 -I ../../src/ -lssl -lcrypto -lsodium
...
int main() {
  ...
  auto program = Program::load(provider, "spl-token.json", PublicKey("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"));
