...
PublicKey associated_token_program_id("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL");
...
TEST_CASE("get_associated_token_address CsfCXcswe5pjoW6M7rgAhXz1GRPAGAYsESozFFPg6AeY") {
  ...
  std::tuple<PublicKey, uint8_t> pda = PublicKey::find_program_address({ owner.to_buffer(), program_id.to_buffer(), mint.to_buffer() }, associated_token_program_id);
